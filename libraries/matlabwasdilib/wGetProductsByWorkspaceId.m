...
%
function asProducts=wGetProductsByWorkspaceId(Wasdi, sWorkspaceId)
% Get the List of Products in a Workspace given its ID
% Syntax
% asProducts=wGetProductsByWorkspaceId(Wasdi, sWorkspaceName);
% 
% INPUT
...
%   asProducts: array of strings that are the names of the products
  ...
  if exist("Wasdi") < 1 
   ...
   aoProducts= Wasdi.getProductsByWorkspaceId(sWorkspaceId);
