...
%
function bIsOnServer = wGetIsOnServer(Wasdi)
%
% Gets whether the code is running on server or not
% Syntax
% bIsOnServer = wGetIsOnServer(Wasdi)
% 
% INPUT
%    Wasdi: Wasdi object created after the wasdilib call
%
% OUTPUT
%   bIsOnServer: true if the code is running on a WASDI server, false otherwise
  ...
  if exist("Wasdi") < 1 
   ...
   bIsOnServer = Wasdi.getIsOnServer();
