...
public class WasdiLib {
     ...
     *
     * @param asInputFileName
     * @param asOutputFileName
     * @param sWorkflowName
...
//			BufferedInputStream oBis = new BufferedInputStream(new FileInputStream(oUploadFile));
    ...
    /**
     * Invokes the conversion using SEN2COR utils on the server
     *
     * @param sProductName The product name of the file that should be converted
     * @param sWorkspaceId The workspace Id in which the file to be converted is stored
     * @param bAsynch
     * @return
     */
    protected String internalExecuteSen2Cor(String sProductName, String sWorkspaceId, boolean bAsynch) {
        String sProcessId;
        ...
        try {
            ...
            log("Sen2Cor : could not prepare URL due to " + oE + ", aborting");
        }
        try {
            // insert http post part -> response is processId

            String sResponse = httpPost(sUrl.toString(), "", getStandardHeaders());
            Map<String, Object> aoJSONMap = s_oMapper.readValue(sResponse, new TypeReference<Map<String, Object>>() {
            });
            ...
            log("Sen2Cor : issue with http post due to " + oE + ", aborting");
        }
        return "";
