...
public class ProcessWorkspaceRepository extends MongoRepository {
    ...
    /**
     * Get aggregation to reconstruct process tree, given the root process ID.
     * In fact the aggregation store all the subprocess in a list
     * To be used to visualize the elaboration profile with rendering libraries
     *
     * @param sParentId The parent process ID to find siblings
     * @return A json containing the data of the parent plus an array of object named
     * siblings that contains all the children processes
     * <p>
     * db.getCollection('processworkpsace').aggregate([
     * <p>
     * {$graphLookup: {
     * from: "processworkpsace",
     * startWith: "$processObjId",
     * connectFromField: "processObjId",
     * connectToField: "parentId",
     * as: "childrend",
     * maxDepth:0
     * }}
     * ,
     * { $match: {processObjId:"bfeafb8f-38ca-444d-b6a8-74b7839b8631"}},
     * { $unset: ["siblings._id","_id"] }
     * <p>
     * ] )
     */
    public List<ProcessWorkspace> getProcessTree(String sParentId) {
